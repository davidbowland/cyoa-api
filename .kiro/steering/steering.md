# Steering for cyoa-api

## Description

The repository is part of a larger project called `cyoa` for `choose your own adventure`. It is an AWS Lambda with associated resources.

Its purpose is to orchestrate the generation and playing of cyoa-style narration games.
